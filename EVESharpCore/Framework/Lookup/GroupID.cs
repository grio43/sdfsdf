...
namespace EVESharpCore.Framework.Lookup
{
    public enum Group
    {
        ...
        AbyssalDeadspaceTriglavianBioAdaptiveCache = 319,
        AbyssalDeadspaceTriglavianTransferConduit = 366, //same as a acceleration gate
        AbyssalDeadspaceUnstableAbyssalDepths = 1971,
        AbyssalDeadspaceAOE_structure = 1973,
        AbyssalDeadspaceWeather = 1975,
        AbyssalDeadspaceCloud = 1980,
        AbyssalDeadspaceAoeTowerWeapon = 1981,
        AbyssalDeadspaceFilament = 1979,
